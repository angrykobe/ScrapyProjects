...
DOWNLOADER_MIDDLEWARES = {
   'job.middlewares.RotateUserAgentMiddleware': 400,
   'job.middlewares.RotateCookieMiddleware': 500,
   'job.middlewares.ProxyMiddleware': 100,
}
...
ITEM_PIPELINES = {
    'job.pipelines.MySQLStorePipeline': 300,
}
